...
document
  .getElementById("loadTimelineBtn")
  .addEventListener("click", loadTimelinePreview);
...
document
  .getElementById("previewPlayBtn")
  ?.addEventListener("click", () => postToPreview({ type: "PLAY" }));
document
  .getElementById("previewPauseBtn")
  ?.addEventListener("click", () => postToPreview({ type: "PAUSE" }));
