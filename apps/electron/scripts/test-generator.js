...
const { readJsonFile, copyDirRecursive, removeDirRecursive } = require("../src/main/services/file-service");
...
async function run() {
  ...
  const mainCode = fs.readFileSync(path.join(remotionSrcDir, "components", "MainSequence.tsx"), "utf8");
