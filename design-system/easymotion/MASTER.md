...
> **Authoritative copy:** `docs/design-system/easymotion/MASTER.md` (aligned with UI布局与交互设计-优化版.md v1.0).
> This file is a skill-generated snapshot; prefer the docs copy for implementation.
