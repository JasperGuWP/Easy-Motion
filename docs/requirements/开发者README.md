...
| [M5-M6-并行开发协作规范.md](docs/requirements/M5-M6-并行开发协作规范.md) | 双人并行 M5/M6 时的模块归属、IPC 契约、合并节奏 |
| [M5-AI对话与Agent-开发规范.md](docs/requirements/M5-AI对话与Agent-开发规范.md) | M5 范围、目录归属、与 M6 接口约定 |
| [M6-素材管理与预设-开发规范.md](docs/requirements/M6-素材管理与预设-开发规范.md) | M6 范围、路径约定、子任务与验收 |
