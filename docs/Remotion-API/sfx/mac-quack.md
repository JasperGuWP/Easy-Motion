---
title: "macQuackv4.0.464"
source: https://www.remotion.dev/docs/sfx/mac-quack
---

# macQuack[v4.0.464](https://github.com/remotion-dev/remotion/releases/v4.0.464)
...
```tsx
https://remotion.media/mac-quack.wavCopy
```
