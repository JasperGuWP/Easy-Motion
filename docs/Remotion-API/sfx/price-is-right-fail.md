---
title: "priceIsRightFailv4.0.464"
source: https://www.remotion.dev/docs/sfx/price-is-right-fail
---

# priceIsRightFail[v4.0.464](https://github.com/remotion-dev/remotion/releases/v4.0.464)
...
```tsx
https://remotion.media/price-is-right-fail.wavCopy
```
