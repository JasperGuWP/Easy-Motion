---
title: "omgHellNahv4.0.464"
source: https://www.remotion.dev/docs/sfx/omg-hell-nah
---

# omgHellNah[v4.0.464](https://github.com/remotion-dev/remotion/releases/v4.0.464)
...
```tsx
https://remotion.media/omg-hell-nah.wavCopy
```
