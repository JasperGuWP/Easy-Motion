...
source: https://www.remotion.dev/docs/rive/remotionrivecanvas
---
...
### `className?`[v4.0.464](https://github.com/remotion-dev/remotion/releases/v4.0.464)[​](#classname "Direct link to classname")

A class name to apply to the underlying `<canvas>` element.

### `style?`[v4.0.464](https://github.com/remotion-dev/remotion/releases/v4.0.464)[​](#style "Direct link to style")

Inline styles to apply to the underlying `<canvas>` element.

## Inherited props[v4.0.464](https://github.com/remotion-dev/remotion/releases/v4.0.464)[​](#inherited-props "Direct link to inherited-props")
