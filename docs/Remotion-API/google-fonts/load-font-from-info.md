---
title: "loadFontFromInfo()v4.0.279"
source: https://www.remotion.dev/docs/google-fonts/load-font-from-info
---

# loadFontFromInfo()[v4.0.279](https://github.com/remotion-dev/remotion/releases/v4.0.279)
