---
title: "useOffthreadVideoTexture()v4.0.83"
source: https://www.remotion.dev/docs/use-offthread-video-texture
---

# ~~useOffthreadVideoTexture()~~[v4.0.83](https://github.com/remotion-dev/remotion/releases/v4.0.83)
...
### `delayRenderTimeoutInMilliseconds`[v4.0.271](https://github.com/remotion-dev/remotion/releases/v4.0.271)[​](#delayrendertimeoutinmilliseconds "Direct link to delayrendertimeoutinmilliseconds")
...
### `delayRenderRetries`[v4.0.271](https://github.com/remotion-dev/remotion/releases/v4.0.271)[​](#delayrenderretries "Direct link to delayrenderretries")
