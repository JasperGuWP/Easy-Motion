---
title: "<ThreeCanvas>"
source: https://www.remotion.dev/docs/three-canvas
---
...
## `frameloop` behavior during rendering[​](#frameloop-behavior-during-rendering "Direct link to frameloop-behavior-during-rendering")
...
## Using videos inside a `<ThreeCanvas>`[​](#using-videos-inside-a-threecanvas "Direct link to using-videos-inside-a-threecanvas")
