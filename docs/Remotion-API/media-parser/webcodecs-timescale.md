...
source: https://www.remotion.dev/docs/media-parser/webcodecs-timescale
---
...
const timescale = WEBCODECS_TIMESCALE; // 1_000_000Copy
```
...
## Getting the native timescale[​](#getting-the-native-timescale "Direct link to Getting the native timescale")
