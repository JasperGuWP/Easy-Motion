---
title: "ensureFfprobe()v3.3"
source: https://www.remotion.dev/docs/renderer/ensure-ffprobe
---

# ensureFfprobe()[v3.3](https://github.com/remotion-dev/remotion/releases/v3.3)
